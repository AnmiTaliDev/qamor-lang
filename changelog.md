...
- Уточнены правила выбора аспекта (нейтральный/прогрессив/хабитуалис) с контрастными примерами
- Добавлена полная таблица склонения (5 падежей × 2 числа)
- Добавлен глагол hyr (искать) — базовый корень для hyrv (поиск)
- Добавлен глагол stev (остановить)
- Добавлен глагол vozn (знакомить)
- Добавлен глагол mozv (встречать)
- Удалена буква γ (гамма) из фонемного инвентаря (теперь 19 согласных)
- Добавлены глаголы: seŋv (следовать), vedl (вести за поводья)
- Добавлена временная лексика: ryŋv (рассвет), syŋv (закат), ryŋgylt (раннее утро), vortek (раньше), prem (прежде)
- Добавлены существительные: noŋm (имя), treŋ (нужда)
- Добавлено вопросительное слово qeŋ (зачем) — отличается от qevr (почему)
- Добавлено наречие trevik (истинно)
- Добавлены сложные понятия: ynvelk (с первого взгляда), tolmvelk (переосмысление)
- Добавлены эмоции: vylpiq (вдохновение), zelviq (предвкушение), lonmor/solmor/xelmor (одиночество: плохое/хорошее/нейтральное)
- Добавлены свойства: zolv (сладкий), gork (горький), vyxp (острый), mylv/mylken (мягкий), tvrk (твёрдый), glyk (гладкий), lekv/lekken (холодный)
- Добавлены люди: vozmor (соратник), telken (педагог), pryvken (философский наставник)
- Добавлены позиции тела: ležv (лежать), sitv (сидеть), stov (стоять)
- Добавлены направления: olvzev (вверх), dulvzev (вниз), nevzev (внутрь)
- Добавлены звуки: sylk (тишина), kryv (крик), šumv (шум)
- Добавлена география: озёра, степи, населённые пункты (urbv, selv, dervn, auyl)
- Добавлено административное деление: gosvt, stran, respv, oblv, regv, provv
- Добавлена химия: 20+ элементов (железо, золото, уран, и др.)
- Добавлена физика: частицы, волны, состояния материи, процессы
- Добавлена политика: власть, идеологии, экономика, выборы
- Добавлена психология: типы любви (12 вариантов), эмоции, травмы
- Добавлены пропущенные слова: zarepvek (катализ), zelkvyk (электролиз), tulqv (движение)
- Добавлены стороны света: varmzev (юг), lekzev (север)
- Минимизировано использование композиции в пользу уникальных корней